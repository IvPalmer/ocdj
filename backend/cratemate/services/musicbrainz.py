...
# Wikimedia image lookup is non-essential for V1 — stub so MusicBrainz collector
# stays import-clean. Bring back the real fetcher if users complain about
# missing artist images post-deploy.
def fetch_wikimedia_image(*args, **kwargs):
    return None
