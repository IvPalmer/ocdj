"""
Native Pixeldrain API client for Django.

Replicated from tools/traxdb_sync/pixeldrain.py with identical logic.
"""
...
class PixeldrainClient:
    ...
    def download_file(
        ...
        *,
        ...
        downloaded=False means it was skipped (already present and matched expected_size).
        """
...
def is_pixeldrain_not_found(e: Exception) -> bool:
    msg = repr(e)
