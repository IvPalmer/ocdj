...
urlpatterns = [
    ...
    path('pipeline/<int:pk>/refresh/', views.pipeline_refresh, name='pipeline-refresh'),
    path('pipeline/<int:pk>/retry-drain/', views.pipeline_retry_drain, name='pipeline-retry-drain'),
